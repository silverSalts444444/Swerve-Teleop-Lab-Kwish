...
public final class Constants {
    ...
    public static final class VisionConstants {
        ...
        private static final double camPitch = Units.degreesToRadians(25.0);
        public static final Transform3d kTopRobotToCam =
                new Transform3d(new Translation3d(Units.inchesToMeters(6), Units.inchesToMeters(11.5), Units.inchesToMeters(34)),
