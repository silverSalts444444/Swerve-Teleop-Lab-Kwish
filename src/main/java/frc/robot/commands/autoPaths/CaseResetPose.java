...
public class CaseResetPose extends SequentialCommandGroup  {
  SwerveDriveTrain swerve;
  AutoPath autoPath;
  
  public CaseResetPose(SwerveDriveTrain swerve) throws FileVersionException, IOException, ParseException {
    this.swerve = swerve;
